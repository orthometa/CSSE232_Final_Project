#---------------------------------------------------------------
# @author: Ishan Saraf, Rahul Yarlagadda, John McClure, David pushi
...
exit:	pop 		#Stack is currently b->a, pop b and return a
		jr
